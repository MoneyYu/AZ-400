// Deploy cmd:
// az deployment group create --resource-group Demo0217 --template-file BICEP.bicep --parameters parameters.json
// New-AzResourceGroupDeployment -ResourceGroupName Demo0217 -TemplateFile .\BICEP.bicep -TemplateParameterFile .\parameters.json

@minLength(3)
@maxLength(24)
param defaultName string = 'demo0218kdf'
